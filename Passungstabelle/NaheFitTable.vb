...
#Region "Local Variables"
    ...
    Public Const mainCmdGroupID As Integer = 3130
    Public Const mainItemID1 As Integer = 31300
    Public Const mainItemID2 As Integer = 31301
    Public Const mainItemID3 As Integer = 31301
    Public Const flyoutGroupID As Integer = 91

    Public eventgesteuert As Boolean = False
    Public Event_AfterRegen As Boolean = False
    Public Event_BevorSave As Boolean = False
...
#Region "SolidWorks Registration"
    ...
    <ComRegisterFunction()> Public Shared Sub RegisterFunction(ByVal t As Type)
        ...
        attributes = System.Attribute.GetCustomAttributes(GetType(NaheFitTable), GetType(SwAddinAttribute))
...
#Region "ISwAddin Implementation"
    ...
    Function ConnectToSW(ByVal ThisSW As Object, ByVal Cookie As Integer) As Boolean Implements SolidWorks.Interop.swpublished.SwAddin.ConnectToSW
        ...
        If pt.Check_for_setup() Then
            ...
            If eventgesteuert = True Then
                Event_AfterRegen = pt.Attr_get_generell("Event_AfterRegen")
                Event_BevorSave = pt.Attr_get_generell("Event_BevorSave")
            End If
        End If
...
#Region "UI Methods"
    Public Sub AddCommandMgr()
        ...
        Dim Title As String = My.Resources.Passungstabelle
        Dim ToolTip As String = My.Resources.Passungstabelle_Add_In_für_SolidWorks
...
#Region "UI Callbacks"
    ...
    Sub PassungsTabelleHilfe()
        ...
        Dim psi As New ProcessStartInfo(macro_pfad & My.Resources.HtmlHelpPfad)
