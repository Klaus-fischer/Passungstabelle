...
Public Class Definitionen
    ...
    'Dictionary für Übersetzungs-Attribute
    Public Shared MSGATTR As New Dictionary(Of String, String) From {{"Msg", ts}, {"Show", tb}}
    'Vorgabewerte für Übersetzungs-Attribute
    Public Shared MSGATTR_Init As New Dictionary(Of String, String) From {{"Msg", ""}, {"Show", False}}
